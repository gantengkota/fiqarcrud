...
$query = "SELECT * FROM tempat_pkl_tj"; // Update the query to the new table
...
<head>
    <meta charset="UTF-8">
    <title>Data Tempat PKL TJ</title>
...
<body>
    ...
    <div class="dashboard">
        <h2>Teknik Jaringan</h2>
        <div class="text-box">
            <p>Berikut adalah tempat PKL untuk jurusan Teknik Jaringan</p>
        </div>
