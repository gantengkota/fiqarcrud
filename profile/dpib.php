...
$query = "SELECT * FROM tempat_pkl_dpib"; // Update the query to the new table
...
<head>
    <meta charset="UTF-8">
    <title>Data Tempat PKL DPIB</title>
...
<body>
    ...
    <div class="dashboard">
        ...
        <div class="text-box">
            <p>Berikut adalah tempat PKL untuk jurusan Desain Permodelan & Informasi Bangunan</p>
        </div>
