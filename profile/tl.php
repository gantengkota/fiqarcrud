...
$query = "SELECT * FROM tempat_pkl_tl"; // Update the query to the new table
...
<head>
    <meta charset="UTF-8">
    <title>Data Tempat PKL TL</title>
...
<body>
    ...
    <div class="dashboard">
        <h2>Teknik Listrik</h2>
        <div class="text-box">
            <p>Berikut adalah tempat PKL untuk jurusan Teknik Listrik</p>
        </div>
