...
$query = "SELECT * FROM tempat_pkl_kp"; // Update the query to the new table
...
<head>
    <meta charset="UTF-8">
    <title>Data Tempat PKL KP</title>
...
<body>
    ...
    <div class="dashboard">
        <h2>Konstruksi Perumahan</h2>
        <div class="text-box">
            <p>Berikut adalah tempat PKL untuk jurusan Konstruksi Perumahan</p>
        </div>
