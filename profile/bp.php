...
$query = "SELECT * FROM tempat_pkl_bp"; // Update the query to the new table
...
<head>
    <meta charset="UTF-8">
    <title>Data Tempat PKL BP</title>
...
<body>
    ...
    <div class="dashboard">
        ...
        <div class="text-box">
            <p>Berikut adalah tempat PKL untuk jurusan Broadcasting & Perfilman</p>
        </div>
